...
export class SeedAdvancedConfig extends SeedConfig {
  ...
  constructor() {
    ...
    this.SYSTEM_CONFIG.paths['localforage'] = `${this.APP_BASE}node_modules/localforage/dist/localforage.js`;
    ...
    this.SYSTEM_BUILDER_CONFIG.paths['localforage'] = `node_modules/localforage/dist/localforage.min.js`;
  }
}
